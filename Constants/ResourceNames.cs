namespace Lombiq.DataTables.Constants
{
    public static class ResourceNames
    {
        ...
        public const string JQuery_DataTables_Plugins_Processing = nameof(JQuery_DataTables_Plugins_Processing);
        public const string JQuery_DataTables_Extensions_Responsive = nameof(JQuery_DataTables_Extensions_Responsive);
