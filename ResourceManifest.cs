    ...
    public class ResourceManifest : IResourceManifestProvider
    {
        ...
        public void BuildManifests(IResourceManifestBuilder builder)
        {
            ...
            manifest
                ...
                .SetDependencies(ResourceNames.JQuery)
                .SetUrl(Vendors + "datatables.net/jquery.dataTables.min.js", Vendors + "datatables.net/jquery.dataTables.js")
            ...
            manifest
                ...
                .SetUrl(Vendors + "datatables.net-buttons/dataTables.buttons.min.js", Vendors + "datatables.net-buttons/dataTables.buttons.js")
                .SetVersion("1.6.3");

            manifest
                .DefineScript(ResourceNames.DataTables.Bootstrap4)
                .SetDependencies(ResourceNames.JQuery, ResourceNames.DataTables.Library)
                .SetUrl(Vendors + "datatables.net-bs4-js/dataTables.bootstrap4.min.js", Vendors + "datatables.net-bs4-js/dataTables.bootstrap4.js")
            ...
            manifest
                ...
                .SetUrl(Vendors + "datatables.net-bs4-css/dataTables.bootstrap4.min.css", Vendors + "datatables.net-bs4-css/dataTables.bootstrap4.css")
            ...
            manifest
                ...
                .SetUrl(Vendors + "datatables.net-bs4-js/buttons.bootstrap4.min.js", Vendors + "datatables.net-bs4-js/buttons.bootstrap4.js")
                .SetVersion("1.6.3");
            ...
            manifest
                ...
                .SetUrl(Vendors + "datatables.net-bs4-css/buttons.bootstrap4.min.css", Vendors + "datatables.net-bs4-css/buttons.bootstrap4.css")
                .SetVersion("1.6.3");
